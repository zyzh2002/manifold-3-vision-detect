...
#
# The toolchain triple and GCC version are derived in aarch64-manifold3.cmake
# (via -dumpmachine / -dumpfullversion) and are in scope here, so the C++ stdlib
# include paths track the toolchain instead of being hardcoded a second time.
...
set(MANIFOLD3_TOOLCHAIN_CXX_INCLUDE
    "${MANIFOLD3_TOOLCHAIN_DIR}/${_gcc_machine}/include/c++/${_gcc_version}")
set(MANIFOLD3_TOOLCHAIN_CXX_ARCH_INCLUDE
    "${MANIFOLD3_TOOLCHAIN_DIR}/${_gcc_machine}/include/c++/${_gcc_version}/${_gcc_machine}")
...
list(JOIN _cxx_flags " " CMAKE_CXX_FLAGS_INIT)
